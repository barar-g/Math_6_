...
const ExerciceComp = ({ vocabularyData,  correctSound, incorrectSound }) => {
...
console.log(vocabularyData)
  ...
  return (
    <div className="vocabulary-trainer">
      ...
      <FormulaTextF styles={{ fontSize: '1em' }}>Donner le complément d'objet direct approprié.</FormulaTextF>
