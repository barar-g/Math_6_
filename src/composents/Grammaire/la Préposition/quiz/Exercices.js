...
const ExercicePréposition = ({ vocabularyData,  correctSound, incorrectSound }) => {
...
console.log(vocabularyData)
  ...
  return (
    <div className="vocabulary-trainer">
      ...
      <FormulaTextF styles={{ fontSize: '1em' }}>Donner la préposition du phrase</FormulaTextF>
...
export default ExercicePréposition;