...
const ExerciceAdv = ({ vocabularyData,  correctSound, incorrectSound }) => {
...
console.log(vocabularyData)
  ...
  return (
    <div className="vocabulary-trainer">
      ...
      <FormulaTextF styles={{ fontSize: '1em' }}>choisir l'adverbe approprié </FormulaTextF>
