...
import './jeux/Style/quiz2.css';

const VocabularyTrainerBah = ({ vocabularyData,  correctSound, incorrectSound }) => {
...
console.log(vocabularyData)
  ...
  return (
    <div className="vocabulary-trainer">
      ...
      <FormulaTextF styles={{ fontSize: '1em' }}>Donner le sujet du phrase</FormulaTextF>
...
export default VocabularyTrainerBah;