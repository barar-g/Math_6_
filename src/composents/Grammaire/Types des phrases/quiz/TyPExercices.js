...
const ExerciceTYPH = ({ vocabularyData,  correctSound, incorrectSound }) => {
...
console.log(vocabularyData)
  ...
  return (
    <div className="vocabulary-trainer">
      ...
      <FormulaTextF styles={{ fontSize: '1em' }}>déterminer le type de chaque phrase </FormulaTextF>
